...
- **Slice 5D (Web Console Script Library UI & Execution Sheets)**: In progress.
  Web Console script library UI sheet, dynamic parameter input form generation from schema, WebCrypto Ed25519 ActionProof V2 signing, script run output inspection modal, and schedule freezing.
