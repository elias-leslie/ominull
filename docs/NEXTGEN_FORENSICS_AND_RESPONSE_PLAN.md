...
| Phase 4 | Demo collector removed | Corrected by slice R0.5 on 2026-09-03 (`docs/evidence/R0-5.md`): the unsafe demo collector hooks were removed from `agent/linux/main.c`. Bounded profile contracts and worker isolation remain to be designed for Phase 4. |
