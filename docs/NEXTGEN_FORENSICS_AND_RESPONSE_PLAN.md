...
| Phase 1A | Slices 1A.0 and 1A.1 verified; slice 1A.2 pending | Slice 1A.0 on 2026-09-03 (`docs/evidence/1A-0.md`) verified snapshot restore on LXC 150 and rehearsed packaging. Slice 1A.1 on 2026-09-03 (`docs/evidence/1A-1.md`) migrated the hub process to dedicated unprivileged system account `ominull:ominull`, deployed and verified live telemetry, package serving, certificate management, diagnostics, and quarantine on LXC 150. Slice 1A.2 (authority service packaging) is underway. |
